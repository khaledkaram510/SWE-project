...
if (isset($_POST['submit'])) {
    ...
    $db = new database; // Instantiate database connection
   // $str = "SELECT email FROM user WHERE email='$email' OR username='$username'";
    //$result = $db->query($str);

    if (mysqli_num_rows($result) > 0) {
        echo "<center><h3><script>alert('Sorry.. This email or username is already registered !!');</script></h3></center>";
        ...
        if ($db->query($str)) {
            ...
            header('location: ../user/index.php?q=1');
        } else {
            echo "Error: " . $db->error(); // Display error if query fails
        }
    }
}
?>
            ...
            <div class="box box-border">
                <div class="box-body">
                    <center>
                        ...
                        <h4 style="font-family: Noto Sans;">Your best choice</h4>
                    </center><br>
