...
(2, 'second product', 'this is the second product', 200, '../images/06-22-465.jpg', 0, 10, 0, 'electronics'),
...
INSERT INTO `user` (`ID`, `first_name`, `last_name`, `username`, `email`, `password`, `phone`, `address`) VALUES
(1, 'khaled', 'karam1', 'khaledkaram', 'k@email.com', '1234', 1425377, 'fasss');
